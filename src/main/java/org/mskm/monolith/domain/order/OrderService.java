...
import static org.mskm.monolith.domain.order.mappings.create_order.CreateOrderDtoMapper.CREATE_ORDER_DTO_MAPPER;
import static org.mskm.monolith.domain.order.mappings.order.OrderDtoMapper.ORDER_DTO_MAPPER;
import static org.mskm.monolith.domain.order.mappings.update_order.UpdateOrderDtoMapper.UPDATE_ORDER_DTO_MAPPER;
...
public class OrderService {
    ...
    public Mono<OrderDto> create(CreateOrderDto createOrderDto) {
        return Mono.justOrEmpty(createOrderDto)
                .map(CREATE_ORDER_DTO_MAPPER::toEntity)
